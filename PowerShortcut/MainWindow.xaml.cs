...
namespace PowerShortcut
{
    ...
    public sealed partial class MainWindow : WindowEx
    {
        ...
        public MainWindow()
        {
            ...
            this.AppWindow.SetIcon(Path.Combine(AppContext.BaseDirectory, "Assets/powershortcut.ico"));
            this.PersistenceId = "PowerShortcutMainWindow";
